    ...
    class LineDivideService {
        ...
        private shiftWithAutoReduce(token: Token) {
            ...
            if (currentTokenWidth > this.view.lineMaxWidth) {
                ...
                //이곳이 줄이 길면 줄을 넘기는 부분. 수정을 하려면 이쪽을 수정해야함.
                /*
                this.view.svgElement.removeAttribute('viewBox')
                this.view.svgElement.setAttribute('viewBox','0 -20 '+ (currentTokenWidth)+' '+ (900+30).toString());*/
